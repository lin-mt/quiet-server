...
package com.github.quiet.json.modifier;
...
import com.github.quiet.json.modifier.serializer.DictSerializer;
...
public class ServiceSerializerModifier extends BeanSerializerModifier {
  ...
  public JsonSerializer<?> modifySerializer(
    ...
    if (Dict.class.isAssignableFrom(beanDesc.getBeanClass())
      ...
      return new DictSerializer((BeanSerializerBase) serializer);
    }
