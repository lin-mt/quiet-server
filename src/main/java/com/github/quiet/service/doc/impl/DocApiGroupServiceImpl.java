...
import com.github.quiet.repository.doc.DocApiGroupRepository;
...
import static com.github.quiet.entity.doc.QDocApiGroup.docApiGroup;
...
public class DocApiGroupServiceImpl implements DocApiGroupService {
  ...
  @Override
  public List<DocApiGroup> listByProjectIdAndName(
      Long projectId, Set<Long> ids, String name, Long limit) {
